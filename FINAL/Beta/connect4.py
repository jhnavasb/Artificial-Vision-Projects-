...
class Game(object):
    ...
    def __init__(self):
        ...
        print("{0} will be {1}, and {2} will be {3}".format(self.players[0].name, self.colors[0], self.players[1].name, self.colors[1]))
...
class Player(object):
    ...
    def move(self, state):
        ...
        '''
        input("Oprima enter cuando haya realizado su jugada")
        return 101
